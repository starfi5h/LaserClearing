...
namespace LaserClearing
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static void LoadConfigs()
        {
            ...
            LocalLaser_Patch.CheckIntervalTick = Instance.Config.Bind("Laser", "CheckIntervalTick", 20, "Interval to check object in range\n检查周期").Value;
            LocalLaser_Patch.MiningPower = Instance.Config.Bind("Laser", "MiningPower", 360f, "Power comsumption per laser (kW)\n激光耗能").Value / 60f * 100f;
